(function() {
  ...
  module.exports = SessionHandler = (function() {
    ...
    SessionHandler.prototype.generate = function(req, token, id, ttl, cookies) {
      var res, _writeHead;
      req.sessionID = token;
    ...
    SessionHandler.prototype._setCookie = function(req, cookies) {
      ...
      val = cookies ? cookies : cookie.serialize(req._appname, req.sessionID);
