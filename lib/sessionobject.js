(function() {
  ...
  module.exports = Session = (function() {
    ...
    Session.prototype.upgrade = function(id, ttl, cookies, cb) {
      if (typeof ttl === "function") {
        ...
        if (cb && cookies && !(Array.isArray(cookies))) {
          cookies = [];
        }
      }
      if ((ttl != null) && ttl < 10) {
      ...
      this.handler.create(this.req, id, ttl, (function(_this) {
        return function(err, token) {
          ...
          _this.handler.generate(_this.req, token, id, ttl, cookies);
          if (cb != null) {
            cb();
          }
        };
